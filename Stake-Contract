...
contract NewCoinStake is Ownable {
    ...
    uint256 public allocation = 1 * DECIMALS; // TBD!!!!!!!!!!!!!!
    uint256 public maxStake = 500000 * DECIMALS; //TBD!!!!!!!!!!!!!!
    uint256 public minStake = 10000 * DECIMALS; //TBD!!!!!!!!!!!!!!!!!!!!!!
    uint256 public roiPerSeconds = 17361; // 0.15 / 1 day * DIVISOR; //TBD!!!!!!!!!!!!!!!!!!!!!!
    ...
    modifier lock() {
        require(unlocked == 1, "NewcoinStake: LOCKED"); //CHANGE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        unlocked = 0;
        _;
        unlocked = 1;
    }
